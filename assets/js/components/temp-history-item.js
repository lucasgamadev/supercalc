  ...
  render() {
    ...
    switch (this.operatorType) {
      case 'conversao-moeda':
        iconContent = '<i class="material-icons" style="font-size: 18px;">currency_exchange</i>';
        break;

      case 'juros-simples':
        iconContent = '<i class="material-icons" style="font-size: 18px;">percent</i>';
        break;

      case 'juros-compostos':
        iconContent = '<i class="material-icons" style="font-size: 18px;">analytics</i>';
        break;

      case 'desconto':
        iconContent = '<i class="material-icons" style="font-size: 18px;">discount</i>';
        break;

      default:
        iconContent = '<i class="material-icons" style="font-size: 18px;">calculate</i>';
        break;
    }
